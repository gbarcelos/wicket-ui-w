...
public class ComponentVisualErrorBehavior extends AjaxFormComponentUpdatingBehavior {
	...
	private static final long serialVersionUID = -1836980649316693667L;
    ...
    protected void onError(AjaxRequestTarget ajaxRequestTarget, RuntimeException e) {
        changeCssClass(ajaxRequestTarget, false, "et_contact_error");
    }
    ...
    protected void onUpdate(AjaxRequestTarget ajaxRequestTarget) {
        changeCssClass(ajaxRequestTarget, true, "input");
    }
